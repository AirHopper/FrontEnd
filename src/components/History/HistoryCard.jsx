      ...
      {orders.map((order) => {
        ...
        return (
          <Box
            ...
            gap={4}
            borderColor={
              selectedOrderId === order.id ? "#44B3F8" : "transparent"
            }
          ...
          >
            ...
            >
              <HStack align="start" spacing={4}>
                ...
                <VStack gap={1} align="flex-start">
                  ...
                  <Text fontSize={"sm"}>
                    {new Date(
                      order.outboundTicket.departure.time
              ...
              <HStack align="start" spacing={4}>
                ...
                <VStack gap={1} align="flex-start">
                  ...
                  <Text fontSize={"sm"}>
                    {new Date(
                      order.outboundTicket.arrival.time
                    ).toLocaleDateString("id-ID", {
                      day: "2-digit",
                      month: "long",
                      year: "numeric",
            ...
            >
              ...
              >
                IDR.{" "}
                {new Intl.NumberFormat("id-ID").format(order.payment.amount)}
              </Text>
            </Grid>
          </Box>
        );
