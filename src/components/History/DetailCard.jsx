    ...
    <Box p={4} my={6}>
      ...
      >
        <VStack gap={0} align="flex-start">
          ...
          <Text fontSize={["sm", "md"]}>
            {new Date(order.outboundTicket.departure.time).toLocaleDateString(
              "id-ID",
              {
                day: "2-digit",
                month: "long",
      ...
      <HStack gap={4} mb={4}>
        <Image
          src={order.outboundTicket.flights[0].airline.logo}
          alt={order.outboundTicket.flights[0].airline.name}
          boxSize="50px"
        />
        <VStack align={"start"} gap={1}>
          ...
          <Text fontSize={["sm", "md"]}>
            Pesawat: {order.outboundTicket.flights[0].airplane}
          </Text>
      ...
      >
        <VStack gap={0} align="flex-start">
          ...
          <Text fontSize={["sm", "md"]}>
            {new Date(order.outboundTicket.arrival.time).toLocaleDateString(
              "id-ID",
              {
                day: "2-digit",
                month: "long",
        ...
        <Box borderBottom="1px solid #A8B6B7" pb={4} mb={4}>
          ...
          <HStack align={"start"} justify={"space-between"} mb={4}>
            <VStack gap={0} align="flex-start">
              ...
              <Text fontSize={["sm", "md"]}>
                {new Date(order.returnTicket.departure.time).toLocaleDateString(
                  "id-ID",
                  {
                    day: "2-digit",
                    month: "long",
          ...
          <HStack gap={4} mb={4}>
            <Image
              src={order.returnTicket.flights[0].airline.logo}
              alt={order.returnTicket.flights[0].airline.name}
              boxSize="50px"
            />
            <VStack align={"start"} gap={1}>
              <Text fontSize={["sm", "md"]} fontWeight="bold">
              ...
              <Text fontSize={["sm", "md"]}>
                Pesawat: {order.returnTicket.flights[0].airplane}
              </Text>
          ...
          <HStack align={"start"} justify={"space-between"} mb={4}>
            <VStack gap={0} align="flex-start">
              ...
              <Text fontSize={["sm", "md"]}>
                {new Date(order.returnTicket.arrival.time).toLocaleDateString(
                  "id-ID",
                  {
                    day: "2-digit",
                    month: "long",
