        ...
        {!!data &&(
          <>
            <Flex justifyContent="center" bg="#73CA5C" color="white" p={2} borderRadius="md" w={["88%", "92%"]} marginLeft={5}>
              <Text fontFamily="Inter, sans-serif" textAlign="center" fontSize={["sm", "md"]}>Business - {availableSeats} Kursi Tersedia</Text>
            </Flex>
            ...
            <Flex justifyContent="center">
              ...
              >
                <Text marginLeft={4} marginTop={2} fontSize={["sm", "md"]}>
                  Business - {selectedSeats.length} Kursi Dipilih
                </Text>
