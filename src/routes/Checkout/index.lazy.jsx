          ...
          <Flex w="75%" direction="column" marginBottom={5}>
            <Stack color="black" marginTop={10} marginLeft={30} marginBottom={5}>
              <BreadcrumbRoot size="lg">
                <BreadcrumbCurrentLink color="black" fontWeight="bold">Isi Data Diri</BreadcrumbCurrentLink>
                <BreadcrumbLink href="#" color="grey" fontWeight="bold">Bayar</BreadcrumbLink>
            ...
            >
              <Box>
                ...
                <Card.Root maxW="sm" bg="white" color="black" w="100%" minWidth="33vw" marginBottom={10}>
                  ...
                  <Card.Body marginBottom={5}>
                    <Box bg="#3C3C3C" color="white" borderTopRadius="lg" h={10} marginTop={5}>
                ...
                <Card.Root maxW="sm" bg="white" color="black" w="100%" minWidth="33vw" marginBottom={8} minHeight="20vw">
                  ...
                  <Box height={5}/>
                  <Text fontWeight="bold" marginLeft={5} marginTop={5} marginBottom={5}>Pilih Kursi Transit</Text>
                ...
                <Button colorPalette={'purple'} width="100%" borderRadius="lg" onClick={handleClick}>Simpan</Button>
              </Box>
              <Box>
                <Card.Root maxW="sm" bg="white" color="black" w="100%" minWidth="30vw" marginBottom={10} border='none'>
                  <Card.Header>
                  ...
                  <Card.Body>
                    ...
                    <Flex justifyContent="space-between" marginTop={1}>
                      ...
                      <Text fontWeight="bold" fontSize="larger" color="#4B1979">IDR 0</Text>
                    </Flex>
                  </Card.Body>
                </Card.Root>
              </Box>
